    ...
    export declare namespace Db {
        ...
        namespace Productos {
            ...
            namespace TblproductosDidi {
                ...
                export const NombreArticulo: string;
                export const StrCategoria: string;
                export const StrDivision: string;
                export const StrFormato: string;
                export const StrGrupo: string;
                export const StrMarca: string;
                export const StrNombre: string;
                export const StrSubCat: string;
                export const StrUpc: string;
                export const Strimagen: string;
            }
